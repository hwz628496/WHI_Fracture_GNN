...
def main(extract_model, cohort = None):
...
if __name__ == "__main__":
    ...
    model_list = {"random_forest": get_random_forest, "elasticnet": get_elasticnet, "lasso": get_lasso, "svm": None, "xgboost": None}

    assert model_type in model_list.keys()
    main(extract_model = model_list[model_type], cohort = cohort)